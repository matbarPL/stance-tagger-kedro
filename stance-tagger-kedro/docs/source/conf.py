...
# stance_tagger_kedro documentation build
...
from stance_tagger_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "stance_tagger_kedro"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "stance_tagger_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "stance_tagger_kedro.tex",
        "stance_tagger_kedro Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "stance_tagger_kedro",
        "Project stance_tagger_kedro codebase.",
        "Data-Science",
    )
]
